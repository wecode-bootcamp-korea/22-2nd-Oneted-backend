...
INSERT INTO `bookmarks` VALUES (2,'2021-07-24 19:14:19.094702','2021-07-24 19:14:19.094742',1,7);
...
INSERT INTO `companies` VALUES (1,'모두싸인','모두싸모두싸인에 접속해 준비된 계약서를 업로드 한 후 계약 상대방의 이메일 주소 또는전화번호를 입력해 서명을 요청하면, 상대방은 이메일이나 카카오톡으로 링크를전달받습니다. 이 링크를 클릭해 전자서명을 하거나 전자 도장을 입력하면 계약이종료됩니다.',178,'{\"latitude\": \"37.490894843703074\", \"longitude\": \" 127.00574996913497\"}',1),(2,'카카오 뱅크','모바퇴근제. http://www.visual.camp',510,'{\"latitude\": \"37.490894843703074\", \"longitude\": \"127.00574996913497\"}',1);
...
-- Dump completed on 2021-07-24 19:18:02
